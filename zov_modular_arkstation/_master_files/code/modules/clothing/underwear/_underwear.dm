...
/obj/item/clothing/underwear
	...
	icon = 'zov_modular_arkstation/_master_files/icons/mob/clothing/underwear.dmi' //if someone is willing to make proper inventory sprites that'd be very cash money
	worn_icon = 'zov_modular_arkstation/_master_files/icons/mob/clothing/underwear.dmi'
	worn_icon_digi = 'zov_modular_arkstation/_master_files/icons/mob/clothing/underwear_digi.dmi'

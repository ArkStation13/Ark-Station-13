...
/datum/weather/rain_storm/generate_overlay_cache()
	...
	for(var/offset in 0 to SSmapping.max_plane_offset)
		...
		// LU
		var/mutable_appearance/glow_overlay = mutable_appearance('zov_modular_arkstation/_master_files/code/modules/omega_station/icons/weather_effects.dmi', weather_state, overlay_layer, null, ABOVE_LIGHTING_PLANE, 100, offset_const = offset)
		glow_overlay.color = weather_color
		gen_overlay_cache += glow_overlay

		var/mutable_appearance/weather_overlay = mutable_appearance('zov_modular_arkstation/_master_files/code/modules/omega_station/icons/weather_effects.dmi', weather_state, overlay_layer, plane = overlay_plane, offset_const = offset)

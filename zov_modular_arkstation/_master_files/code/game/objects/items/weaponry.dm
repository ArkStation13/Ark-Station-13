...
/obj/item/ammo_casing/energy/electrode/bolestrel
	...
	select_name = "pain"
	fire_sound = 'zov_modular_arkstation/_master_files/sound/weapons/bowfire.wav'
	e_cost = 50
	harmful = FALSE

/obj/projectile/energy/electrode/bolestrel
	icon = 'zov_modular_arkstation/_master_files/icons/obj/projectiles.dmi'
	icon_state = "cbbolt"
	hitsound = 'zov_modular_arkstation/_master_files/sound/weapons/nebhit.ogg'
...
/obj/item/gun/ballistic/automatic/ak12 // TO FIX
	...
	burst_size = 3
	fire_delay = 1
	fire_sound = 'zov_modular_arkstation/_master_files/sound/weapons/ak12_fire.ogg'

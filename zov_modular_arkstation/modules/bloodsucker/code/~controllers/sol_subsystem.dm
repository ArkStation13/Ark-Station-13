...
/datum/controller/subsystem/processing/sunlight/proc/warn_notify(mob/target, danger_level, message)
	...
	switch(danger_level)
		if(DANGER_LEVEL_FIRST_WARNING)
			target.playsound_local(null, 'zov_modular_arkstation/modules/bloodsucker/sound/griffin_3.ogg', 50, TRUE)
		if(DANGER_LEVEL_SECOND_WARNING)
			target.playsound_local(null, 'zov_modular_arkstation/modules/bloodsucker/sound/griffin_5.ogg', 50, TRUE)

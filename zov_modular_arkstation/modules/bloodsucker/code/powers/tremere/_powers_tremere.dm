...
/datum/action/cooldown/bloodsucker/targeted/tremere
	...
	button_icon = 'zov_modular_arkstation/modules/bloodsucker/icons/mob/actions/tremere_bloodsucker.dmi'
	background_icon = 'zov_modular_arkstation/modules/bloodsucker/icons/mob/actions/tremere_bloodsucker.dmi'

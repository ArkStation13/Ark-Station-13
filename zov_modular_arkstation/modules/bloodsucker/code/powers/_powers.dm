/datum/action/cooldown/bloodsucker
	...
	background_icon = 'zov_modular_arkstation/modules/bloodsucker/icons/mob/actions/bloodsucker.dmi'
	background_icon_state = "vamp_power_off"
	button_icon = 'zov_modular_arkstation/modules/bloodsucker/icons/mob/actions/bloodsucker.dmi'

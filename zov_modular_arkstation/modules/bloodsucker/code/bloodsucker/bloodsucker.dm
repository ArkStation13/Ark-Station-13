/datum/antagonist/bloodsucker
	...
	hijack_speed = 0.5
	hud_icon = 'zov_modular_arkstation/modules/bloodsucker/icons/bloodsucker_icons.dmi'
...
/datum/antagonist/bloodsucker/greet()
	...
	owner.current.playsound_local(null, 'zov_modular_arkstation/modules/bloodsucker/sounds/BloodsuckerAlert.ogg', 100, FALSE, pressure_affected = FALSE)

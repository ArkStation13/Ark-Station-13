...
/obj/structure/bloodsucker/bloodthrone
	...
	icon = 'zov_modular_arkstation/modules/bloodsucker/icons/vamp_obj_64.dmi'
	icon_state = "throne"
	buckle_lying = 0
	anchored = FALSE
	density = TRUE
...
/obj/structure/bloodsucker/bloodthrone/proc/GetArmrest()
	return mutable_appearance('zov_modular_arkstation/modules/bloodsucker/icons/vamp_obj_64.dmi', "thronearm")

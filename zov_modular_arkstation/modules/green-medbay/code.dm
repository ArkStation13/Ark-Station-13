...
/obj/item/radio/headset/headset_med/green
	icon = 'zov_modular_arkstation/modules/green-medbay/icons/icons.dmi'

// BACKPACKS

/obj/item/storage/backpack/medic/green
	icon = 'zov_modular_arkstation/modules/green-medbay/icons/clothing/backpacks_obj.dmi'
	worn_icon = 'zov_modular_arkstation/modules/green-medbay/icons/clothing/backpacks_mob.dmi'

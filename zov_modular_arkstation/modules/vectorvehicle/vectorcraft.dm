...
/obj/vehicle/sealed/vectorcraft
	...
	icon = 'zov_modular_arkstation/modules/vectorvehicle/vehicles.dmi'
...
/obj/vehicle/sealed/vectorcraft/proc/check_boost()
	...
	if(boost_cooldown < world.time)
		boost_cooldown = 0
		playsound(src.loc,'zov_modular_arkstation/modules/vectorvehicle/sound/boost_ready.ogg', 65, 0)
	return
...
if(driver.sprinting && !(boost_cooldown))
	...
	playsound(src.loc,'zov_modular_arkstation/modules/vectorvehicle/sound/boost.ogg', 50, 0)
	//playsound
*/
...
/obj/vehicle/sealed/vectorcraft/proc/calc_acceleration() //Make speed 0 - 100 regardless of gear here
	...
	if(!enginesound_delay)
		playsound(src.loc,'zov_modular_arkstation/modules/vectorvehicle/sound/norm_eng.ogg', 25, 0)
...
/obj/vehicle/sealed/vectorcraft/proc/calc_vector(direction)
	...
	// 	playsound(src.loc,'zov_modular_arkstation/modules/vectorvehicle/sound/boost.ogg', 100, 0)
	// 	boost_active = TRUE
		//playsound
...
/obj/vehicle/sealed/vectorcraft/proc/friction(change, sfx = FALSE)
	...
	if(sfx)
		playsound(src.loc,'zov_modular_arkstation/modules/vectorvehicle/sound/skid.ogg', 50, 0)

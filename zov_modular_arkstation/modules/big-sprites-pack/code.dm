...
/obj/structure/tank_dispenser
	...
	icon = 'zov_modular_arkstation/modules/big-sprites-pack/dispensers.dmi'
	icon_state = "dispenser"

/obj/item/folder
	name = "folder"
	desc = "A folder."
	icon = 'zov_modular_arkstation/modules/big-sprites-pack/folders.dmi'

/obj/item/shard
	icon = 'zov_modular_arkstation/modules/big-sprites-pack/shards.dmi'
	icon_state = "large"

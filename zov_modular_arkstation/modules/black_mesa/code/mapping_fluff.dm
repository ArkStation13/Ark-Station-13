...
/obj/structure/mineral_door/xen
	name = "organic door"
	color = "#ff8d58"
	icon = 'zov_modular_arkstation/modules/black_mesa/icons/xen_door.dmi'
	icon_state = "resin"
	openSound = 'zov_modular_arkstation/modules/black_mesa/sound/xen_door.ogg'
	closeSound = 'zov_modular_arkstation/modules/black_mesa/sound/xen_door.ogg'
...
/obj/structure/pod
	...
	icon = 'zov_modular_arkstation/modules/black_mesa/icons/structures.dmi'
	icon_state = "pod"

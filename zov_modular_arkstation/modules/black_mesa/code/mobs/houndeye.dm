/mob/living/simple_animal/hostile/blackmesa/xen/houndeye
	...
	alert_sounds = list(
		'zov_modular_arkstation/modules/black_mesa/sound/mobs/houndeye/he_alert1.ogg',
		'zov_modular_arkstation/modules/black_mesa/sound/mobs/houndeye/he_alert2.ogg',
		'zov_modular_arkstation/modules/black_mesa/sound/mobs/houndeye/he_alert3.ogg',
		'zov_modular_arkstation/modules/black_mesa/sound/mobs/houndeye/he_alert4.ogg',
		'zov_modular_arkstation/modules/black_mesa/sound/mobs/houndeye/he_alert5.ogg'
	)
	/// Charging ability

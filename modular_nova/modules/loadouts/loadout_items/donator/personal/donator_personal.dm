...
/datum/loadout_item/toys/teasefoxplush
	...
	// ARK STATION REMOVE: ckeywhitelist = list("ratraus")
...
/datum/loadout_item/head/goldengoggles
	...
	// ARK STATION REMOVE: ckeywhitelist = list("goldenalpharex")
...
/datum/loadout_item/under/jumpsuit/plasmaman_jax
	...
	// ARK STATION REMOVE: ckeywhitelist = list("candlejax")
...
/datum/loadout_item/mask/divemask_koru
	...
	// ARK STATION REMOVE: ckeywhitelist = list("koruu", "foxyandiknowit", "candlejax", "shyelf", "opportunerover22")
...
/datum/loadout_item/mask/luchador_mask
	...
	// ARK STATION REMOVE: ckeywhitelist = list("enzoman")
...
/datum/loadout_item/mask/caligram_visage_mask
	...
	// ARK STATION REMOVE: ckeywhitelist = list("farsightednightlight")
...
/datum/loadout_item/suit/brasspriest
	...
	// ARK STATION REMOVE: ckeywhitelist = list("ChillyLobster")
...
/datum/loadout_item/under/jumpsuit/captain_dress
	...
	// ARK STATION REMOVE: ckeywhitelist = list("netrakyram")
...
/datum/loadout_item/neck/kiaracloak
	...
	// ARK STATION REMOVE: ckeywhitelist = list("inferno707")
...
/datum/loadout_item/neck/zuliecloak
	...
	// ARK STATION REMOVE: ckeywhitelist = list("asky")
...
/datum/loadout_item/under/jumpsuit/lannese
	...
	// ARK STATION REMOVE: ckeywhitelist = list("kathrinbailey")
...
/datum/loadout_item/suit/delta_coat
	...
	// ARK STATION REMOVE: ckeywhitelist = list("deltatri")
...
/datum/loadout_item/neck/silvercross
	...
	// ARK STATION REMOVE: ckeywhitelist = list("m97screwsyourparents")

/datum/loadout_item/suit/occult_coat
	name = "Occult Collector's Coat"
	item_path = /obj/item/clothing/suit/hooded/occult
	// ARK STATION REMOVE: ckeywhitelist = list("gamerguy14948")
...
/datum/loadout_item/mask/octusvox
	...
	// ARK STATION REMOVE: ckeywhitelist = list("octus")

/datum/loadout_item/glasses/roseglasses
	name = "Rose-Colored Glasses"
	item_path = /obj/item/clothing/glasses/rosecolored
	// ARK STATION REMOVE: ckeywhitelist = list("1ceres", "irrigoimport", "zeskorion", "wizardlywoz", "duckymomo", "samarai1000", "funkyfetusstrikesback", "m97screwsyourparents", "lynxqueen", "kaynite", "mahalia", "sapphoqueer", "emmakisst", "ceasethebridge", "valorthix" )
...
/datum/loadout_item/suit/gorlex_harness
	...
	// ARK STATION REMOVE: ckeywhitelist = list("1ceres")
...
/datum/loadout_item/pocket_items/tacticalbrush
	...
	// ARK STATION REMOVE: ckeywhitelist = list("weredoggo")
...
/datum/loadout_item/toys/immovable_rod_plush
	...
	// ARK STATION REMOVE: ckeywhitelist = list("tobjv")
...
/datum/loadout_item/under/jumpsuit/redhosneck
	...
	// ARK STATION REMOVE: ckeywhitelist = list("ultimarifox")
...
/datum/loadout_item/accessory/mercbadge
	...
	// ARK STATION REMOVE: ckeywhitelist = list("konstyantyn")
...
/datum/loadout_item/suit/rainbowcoat
	...
	// ARK STATION REMOVE: ckeywhitelist = list("dudewithatude")
...
/datum/loadout_item/under/jumpsuit/nt_idol
	...
	// ARK STATION REMOVE: ckeywhitelist = list("tetrako")
	restricted_roles = list(JOB_NT_REP)
...
/datum/loadout_item/toys/plushie_chiara
	...
	// ARK STATION REMOVE: ckeywhitelist = list("srq", "superlagg")
...
/datum/loadout_item/under/jumpsuit/bimpcap
	...
	restricted_roles = list(JOB_CAPTAIN)
	// ARK STATION REMOVE: ckeywhitelist = list("razurath")
...
/datum/loadout_item/toys/plushie_elofy
	...
	//// ARK STATION REMOVE: ckeywhitelist = list("october23") // Asked it to be public.

/datum/loadout_item/suit/elofy
	name = "Solar Admiral Coat"
	item_path = /obj/item/clothing/suit/armor/hos/elofy
	// ARK STATION REMOVE: ckeywhitelist = list("october23")
	restricted_roles = list(JOB_HEAD_OF_SECURITY)
...
/datum/loadout_item/pocket_items/transponder
	...
	// ARK STATION REMOVE: ckeywhitelist = list("glacii")
...
/datum/loadout_item/under/jumpsuit/goldenkimono
	...
	// ARK STATION REMOVE: ckeywhitelist = list("sigmaralkahest")
...
/datum/loadout_item/suit/lt3_armor
	...
	// ARK STATION REMOVE: ckeywhitelist = list("lt3")
...
/datum/loadout_item/inhand/hardlight_wheelchair
	...
	// ARK STATION REMOVE: ckeywhitelist = list("sqnztb")
...
/datum/loadout_item/under/jumpsuit/noble_gambeson
	...
	// ARK STATION REMOVE: ckeywhitelist = list("grasshand")
...
/datum/loadout_item/under/jumpsuit/old_qm_jumpskirt
	...
	// ARK STATION REMOVE: ckeywhitelist = list("jasohavents")
...
/datum/loadout_item/under/miscellaneous/rem
	...
	// ARK STATION REMOVE: ckeywhitelist = list("ignari")
...
/datum/loadout_item/inhand/pet/mrfluff_mothroach
	...
	// ARK STATION REMOVE: ckeywhitelist = list("centralsmith")

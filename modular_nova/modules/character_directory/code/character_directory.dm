...
/datum/character_directory/ui_static_data(mob/user)
	...
	var/noncon
	var/hypno
	// var/veteran_status // ARK STATION EDIT
	var/character_ad
	var/headshot
	var/ref
	...
	for(var/mob/mob in GLOB.alive_player_list)
		...
		// veteran_status = mob.client && SSplayer_ranks.is_veteran(mob.client, admin_bypass = FALSE) // ARK STATION EDIT
		...
		directory_mobs.Add(list(list(
			...
			"noncon" = noncon,
			"hypno" = hypno,
			// "veteran_status" = veteran_status, // ARK STATION EDIT

...
/obj/item/dyespray/proc/dye(mob/target, mob/user)
	...
	if(gradient_or_hair == DYE_OPTION_HAIR_COLOR)
		var/new_color = tgui_color_picker(usr, "Choose a hair color:", "Character Preference", "#" + human_target.hair_color) // ARK STATION EDIT: TGUI COLOR PICKER
		...
		var/new_grad_color = tgui_color_picker(usr, "Choose a secondary hair color:", "Dye Spray", human_target.grad_color) // ARK STATION EDIT: TGUI COLOR PICKER

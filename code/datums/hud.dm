...
GLOBAL_LIST_INIT(huds, list(
	...
	// DATA_HUD_PERMIT = new/datum/atom_hud/data/human/permit(), // NOVA EDIT ADDITION // ARK STATION REMOVED
))
...
GLOBAL_LIST_INIT(trait_to_hud, list(
	...
	// TRAIT_PERMIT_HUD = DATA_HUD_PERMIT, // NOVA EDIT ADDITION // NOVA EDIT ADDITION // ARK STATION REMOVED
))

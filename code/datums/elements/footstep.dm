...
/datum/element/footstep/Attach(datum/target, footstep_type = FOOTSTEP_MOB_BAREFOOT, volume = 0.5, e_range = -8, sound_vary = FALSE)
	...
	switch(footstep_type)
		...
		if(FOOTSTEP_MOB_SILICON) // ARK STATION ADDITION
			footstep_sounds = 'zov_modular_arkstation/_master_files/sound/silicon_footsteps/servostep.ogg' // ARK STATION ADDITION

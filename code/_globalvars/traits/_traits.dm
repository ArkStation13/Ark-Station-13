...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		// "TRAIT_HAS_CRANIAL_FISSURE" = TRAIT_HAS_CRANIAL_FISSURE, // ARK STATION REMOVED
...
>>>>>>> 6c1e14df9b3... [MIRROR] Limits the methods through which you can be stunned by a shove. Shoves disarm people who are knocked down. [MDB IGNORE] (#3579)
	...
	/obj/item/bodypart = list(
		...
		// "TRAIT_IMMUNE_TO_CRANIAL_FISSURE" = TRAIT_IMMUNE_TO_CRANIAL_FISSURE, // ARK STATION REMOVED
	),
	/obj/item/bodypart = list(

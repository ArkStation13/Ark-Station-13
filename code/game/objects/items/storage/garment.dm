...
/obj/item/storage/bag/garment/engineering_chief
	name = "tech overseer's garment bag" // ARK STATION EDIT
	desc = "A bag for storing extra clothes and shoes. This one belongs to the Tech Overseer." // ARK STATION EDIT

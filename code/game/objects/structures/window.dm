...
/obj/structure/window/reinforced/plasma/plastitanium
	...
	canSmoothWith = SMOOTH_GROUP_SYNDICATE_WALLS + SMOOTH_GROUP_AIRLOCK + SMOOTH_GROUP_WINDOW_FULLTILE_PLASTITANIUM + SMOOTH_GROUP_PLASTITANIUM_WALLS // ARK STATION EDIT
	explosion_block = 3

...
#define JOB_DISPLAY_ORDER_BRIG_PILOT 53 // ARK STATION EDIT ADDITION
#define JOB_DISPLAY_ORDER_DEACON 54 // ARK STATION EDIT ADDITION
#define JOB_DISPLAY_ORDER_FISCAL 55 // ARK STATION EDIT ADDITION

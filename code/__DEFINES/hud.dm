...
#define ui_glasses "WEST+2:10,SOUTH+2:9" // ARK STATION EDIT: EXTRA INVENTORY PORT - ORIGINAL: "WEST:6,SOUTH+3:11"
#define ui_mask "WEST+1:8,SOUTH+2:9"
#define ui_ears "WEST+2:10,SOUTH+3:11"  // ARK STATION EDIT: EXTRA INVENTORY PORT - ORIGINAL: "WEST+2:10,SOUTH+2:9"

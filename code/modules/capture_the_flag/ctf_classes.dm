...
/datum/outfit/ctf
	...
	var/list/nodrop_slots = list(ITEM_SLOT_OCLOTHING, ITEM_SLOT_GLOVES, ITEM_SLOT_FEET, ITEM_SLOT_ICLOTHING, ITEM_SLOT_EARS_LEFT, ITEM_SLOT_EARS_RIGHT) // ARK STATION EDIT - Extra Inventory

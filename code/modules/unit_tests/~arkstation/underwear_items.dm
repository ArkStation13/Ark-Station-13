...
/datum/unit_test/underwear_items
	...
	var/list/files_by_type = list( // thanks linux for not using the fucking root directory
		briefs = 'zov_modular_arkstation/_master_files/code/modules/clothing/underwear/~generated_files/briefs.dm',
		shirt = 'zov_modular_arkstation/_master_files/code/modules/clothing/underwear/~generated_files/shirt.dm',
		socks = 'zov_modular_arkstation/_master_files/code/modules/clothing/underwear/~generated_files/socks.dm'
	)
...
/datum/unit_test/underwear_items/Run()
	...
	if(fail)
		TEST_FAIL("Underwear items generated files are out of date. Run locally by enabling unit tests, (see _compile_options.dm) and copy 'data/~generated_files' to 'zov_modular_arkstation/_master_files/code/modules/clothing/underwear/~generated_files'")

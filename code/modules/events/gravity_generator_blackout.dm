/datum/round_event_control/gravity_generator_blackout
	...
	description = "Выключает гравитационный генератор."
...
/datum/round_event/gravity_generator_blackout/announce(fake)
	priority_announce("Гравитационносферные аномалии обнаружены вблизи [station_name()]. Требуется ручной сброс генераторов.", "Anomaly Alert", ANNOUNCER_GRANOMALIES)

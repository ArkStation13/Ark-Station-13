...
/datum/job/security_officer/proc/setup_department(mob/living/carbon/human/spawning, client/player_client)
	...
	if(ears)
		if(spawning.ears)
			qdel(spawning.ears)
		spawning.equip_to_slot_or_del(new ears(spawning),ITEM_SLOT_EARS_LEFT) //ARK STATION EDIT - Extra Inventory
...
/datum/outfit/job/security
	...
	head = /obj/item/clothing/head/helmet/sec //NOVA EDIT CHANGE - Original: /obj/item/clothing/head/helmet/sec // СУКА, ВЫ ЗАЕБАЛИ, ПИДОРЫ ЕБЛИВЫЕ

...
SUBSYSTEM_DEF(dynamic)
	...
	var/threat_curve_centre = 0 // ARK STATION EDIT || 0

	/// A number between 0.5 and 4.
	/// Higher value will favour extreme rounds and
	/// lower value rounds closer to the average.
	var/threat_curve_width = 1.2 // ARK STATION EDIT || 1.8
	...
	var/roundstart_split_curve_centre = 0 // ARK STATION EDIT || 0

	/// A number between 0.5 and 4.
	/// Equivalent to threat_curve_width, but for the budget split.
	/// Higher value will favour more variance in splits and
	/// lower value rounds closer to the average.
	var/roundstart_split_curve_width = 1.2 // ARK STATION EDIT || 1.8

...
/datum/controller/subsystem/dynamic/proc/generate_threat()
	...
	var/calculated_max_threat = (SSticker.totalPlayers < low_pop_player_threshold) ? LERP(low_pop_maximum_threat, max_threat_level, SSticker.totalPlayers / low_pop_player_threshold) : max_threat_level // ARK STATION EDIT || var/calculated_max_threat = (SSticker.totalPlayersReady < low_pop_player_threshold) ? LERP(low_pop_maximum_threat, max_threat_level, SSticker.totalPlayersReady / low_pop_player_threshold) : max_threat_level
	log_dynamic("Calculated maximum threat level based on player count of [SSticker.totalPlayers]: [calculated_max_threat]") // ARK STATION EDIT || log_dynamic("Calculated maximum threat level based on player count of [SSticker.totalPlayersReady]: [calculated_max_threat]")
...
/datum/controller/subsystem/dynamic/proc/setup_parameters()
	...
	SSblackbox.record_feedback(
		...
		list(
			...
			"max_threat" = (SSticker.totalPlayers < low_pop_player_threshold) ? LERP(low_pop_maximum_threat, max_threat_level, SSticker.totalPlayers / low_pop_player_threshold) : max_threat_level, // ARK STATION EDIT || "max_threat" = (SSticker.totalPlayersReady < low_pop_player_threshold) ? LERP(low_pop_maximum_threat, max_threat_level, SSticker.totalPlayersReady / low_pop_player_threshold) : max_threat_level,
			"player_count" = SSticker.totalPlayers, // ARK STATION EDIT || "player_count" = SSticker.totalPlayersReady,

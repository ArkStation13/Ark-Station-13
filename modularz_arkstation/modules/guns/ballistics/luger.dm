/obj/item/gun/ballistic/automatic/pistol/luger
	...
	fire_sound = 'modularz_arkstation/modules/guns/sound/guns/fire/luger_fire.ogg'
	load_sound = 'modularz_arkstation/modules/guns/sound/guns/fire/luger_mag_insert.ogg'
	load_empty_sound = 'modularz_arkstation/modules/guns/sound/guns/fire/luger_mag_insert.ogg'
	eject_sound = 'modularz_arkstation/modules/guns/sound/guns/fire/luger_mag_release.ogg'
	eject_empty_sound = 'modularz_arkstation/modules/guns/sound/guns/fire/luger_mag_release.ogg'
	rack_sound =  'modularz_arkstation/modules/guns/sound/guns/fire/luger_rack.ogg'

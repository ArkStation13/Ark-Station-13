...
/obj/structure/bloodsucker/bloodthrone
	...
	icon = 'modularz_arkstation/modules/bloodsucker/icons/obj/structures/vamp_obj_64.dmi'
	icon_state = "throne"
	buckle_lying = 0
	anchored = FALSE
	density = TRUE
...
/obj/structure/bloodsucker/bloodthrone/proc/GetArmrest()
	return mutable_appearance('modularz_arkstation/modules/bloodsucker/icons/obj/structures/vamp_obj_64.dmi', "thronearm")

...
/datum/antagonist/vassal/proc/return_vassal_examine(mob/living/viewer)
	...
	if(master.owner == viewer.mind)
		...
		returnIcon = "[icon2html('modularz_arkstation/modules/bloodsucker/icons/misc/language.dmi', world, "vassal")]"
	// Am I someone ELSE'S Vassal?
		...
		returnIcon = "[icon2html('modularz_arkstation/modules/bloodsucker/icons/misc/language.dmi', world, "vassal_grey")]"

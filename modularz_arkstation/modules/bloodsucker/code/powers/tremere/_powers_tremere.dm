...
/datum/action/cooldown/bloodsucker/targeted/tremere
	...
	button_icon = 'modularz_arkstation/modules/bloodsucker/icons/mob/actions/tremere_bloodsucker.dmi'
	background_icon = 'modularz_arkstation/modules/bloodsucker/icons/mob/actions/tremere_bloodsucker.dmi'

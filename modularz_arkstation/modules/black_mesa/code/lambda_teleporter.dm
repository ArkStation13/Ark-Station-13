...
/datum/looping_sound/lambda
	mid_sounds = list('modularz_arkstation/modules/black_mesa/sound/lc_mainbeam.ogg' = 1)
...
/obj/effect/bump_teleporter/lambda/teleport_action(atom/movable/target, turf/destination)
	...
	playsound(src, 'modularz_arkstation/modules/black_mesa/sound/lc_teleport.ogg', 100)

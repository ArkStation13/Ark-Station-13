...
/obj/structure/mineral_door/xen
	name = "organic door"
	color = "#ff8d58"
	icon = 'modularz_arkstation/modules/black_mesa/icons/xen_door.dmi'
	icon_state = "resin"
	openSound = 'modularz_arkstation/modules/black_mesa/sound/xen_door.ogg'
	closeSound = 'modularz_arkstation/modules/black_mesa/sound/xen_door.ogg'
...
/obj/structure/pod
	...
	icon = 'modularz_arkstation/modules/black_mesa/icons/structures.dmi'
	icon_state = "pod"

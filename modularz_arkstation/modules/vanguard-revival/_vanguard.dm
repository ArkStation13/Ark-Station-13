...
/obj/structure/closet/crate/secure/exp_corps
	...
	icon = 'modularz_arkstation/modules/vanguard-revival/icons/obj/crates.dmi'
...
/obj/structure/closet/secure_closet/vanguard
	...
	req_access = list(ACCESS_GATEWAY, ACCESS_CENT_GENERAL)
	icon = 'modularz_arkstation/modules/vanguard-revival/icons/obj/closet.dmi'
	icon_state = "exp"

//expeditionary MOD suit

/obj/item/mod/construction/plating/exp
	icon = 'modularz_arkstation/modules/vanguard-revival/icons/obj/clothing/mod_construction.dmi'
...
/datum/mod_theme/exp
	...
	variants = list(
		"exp" = list(
		MOD_ICON_OVERRIDE = 'modularz_arkstation/modules/vanguard-revival/icons/obj/clothing/mod_clothing.dmi', // Ark Station 13 Edit
		MOD_WORN_ICON_OVERRIDE = 'modularz_arkstation/modules/vanguard-revival/icons/mob/clothing/mod_clothing.dmi', // Ark Station 13 Edit

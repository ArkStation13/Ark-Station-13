...
/obj/structure/closet/secure_closet/security_medic
	...
	// icon = 'modularz_arkstation/modules/security-medic-renewal/icons/misc.dmi' // ПЕРЕЗАПИСАЛ ТУТ modularz_arkstation\modules\new-closets\code.dm
	// icon_state = "brigdoc"														 // ПЕРЕЗАПИСАЛ ТУТ modularz_arkstation\modules\new-closets\code.dm

...
//
	...
	if(!HAS_TRAIT(user, TRAIT_MIMING))
		playsound(user, user.gender == MALE ? 'modularz_arkstation/modules/now-we-can-jump/jump_male.ogg' : 'modularz_arkstation/modules/now-we-can-jump/jump_female.ogg', 25, 0, 1)

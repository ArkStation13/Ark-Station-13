/obj/item/clothing/head/bridge_officer_beret
	...
	icon = 'modularz_arkstation/modules/new-roles/icons/obj/head.dmi'
	worn_icon = 'modularz_arkstation/modules/new-roles/icons/mob/head.dmi'
...
/obj/item/clothing/under/rank/bridge_officer_uniform
	...
	icon = 'modularz_arkstation/modules/new-roles/icons/obj/under.dmi'
	worn_icon = 'modularz_arkstation/modules/new-roles/icons/mob/under.dmi'
	worn_icon_digi = 'modularz_arkstation/modules/new-roles/icons/mob/under_digi.dmi'
...
/obj/item/clothing/suit/toggle/lawyer/bridge_officer_jacket
	...
	icon = 'modularz_arkstation/modules/new-roles/icons/obj/suits.dmi'
	worn_icon = 'modularz_arkstation/modules/new-roles/icons/mob/suits.dmi'
	supports_variations_flags = CLOTHING_DIGITIGRADE_VARIATION_NO_NEW_ICON

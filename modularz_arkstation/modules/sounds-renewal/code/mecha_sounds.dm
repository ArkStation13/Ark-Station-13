...
/obj/vehicle/sealed/mecha
	var/nominal_sound = 'modularz_arkstation/modules/sounds-renewal/sound/mecha/nominal.ogg'
	var/imag_enh_sound = 'modularz_arkstation/modules/sounds-renewal/sound/mecha/imag_enh.ogg'

/obj/vehicle/sealed/mecha/marauder/mauler
	nominal_sound = 'modularz_arkstation/modules/sounds-renewal/sound/mecha/nominal_syndicate.ogg'
	imag_enh_sound = 'modularz_arkstation/modules/sounds-renewal/sound/mecha/imag_enh_syndicate.ogg'
...
/obj/vehicle/sealed/mecha/savannah_ivanov
	nominal_sound = 'modularz_arkstation/modules/sounds-renewal/sound/mecha/nominal_russian.ogg'
	imag_enh_sound = 'modularz_arkstation/modules/sounds-renewal/sound/mecha/imag_enh_russian.ogg'

...
/obj/item/gun/ballistic/shotgun
	fire_sound = 'modularz_arkstation/modules/sounds-renewal/sound/weapons/gunshotshotgunshot.ogg'
	load_sound = 'modularz_arkstation/modules/sounds-renewal/sound/weapons/shotguninsert.ogg'
	rack_sound = 'modularz_arkstation/modules/sounds-renewal/sound/weapons/shotgun_pump.ogg'
...
/obj/item/gun/ballistic/revolver
	fire_sound = 'modularz_arkstation/modules/sounds-renewal/sound/weapons/revolvershot.ogg'

/obj/item/gun/ballistic/automatic
	fire_sound = 'modularz_arkstation/modules/sounds-renewal/sound/weapons/gunshot_smg_alt.ogg'

/obj/item/gun/ballistic/automatic/sol_smg
	fire_sound = 'modularz_arkstation/modules/sounds-renewal/sound/weapons/gunshot_smg_alt.ogg'

/obj/item/gun/ballistic/automatic/l6_saw
	fire_sound = 'modularz_arkstation/modules/sounds-renewal/sound/weapons/lmgshot.ogg'
...
/obj/machinery/door/airlock
	doorDeni = 'modularz_arkstation/modules/sounds-renewal/sound/machines/deniedbeep.ogg'
...
/area/station/service/chapel
	...
	ambient_buzz_vol = 25
	ambientsounds = list('modularz_arkstation/modules/sounds-renewal/sound/ambience/church-bell1.ogg',
...
/area/shuttle/pirate/nri
	...
	ambientsounds = list('modular_nova/modules/encounters/sounds/alarm_radio.ogg',
						...
						'modular_nova/modules/encounters/sounds/gear_stop.ogg',
						'modular_nova/modules/encounters/sounds/intercom_loop.ogg',
						'modularz_arkstation/modules/sounds-renewal/sound/ambience/radio/1.ogg',
						'modularz_arkstation/modules/sounds-renewal/sound/ambience/radio/2.ogg',
						'modularz_arkstation/modules/sounds-renewal/sound/ambience/radio/3.ogg',
						'modularz_arkstation/modules/sounds-renewal/sound/ambience/radio/4.ogg',
						'modularz_arkstation/modules/sounds-renewal/sound/ambience/radio/5.ogg',
						'modularz_arkstation/modules/sounds-renewal/sound/ambience/radio/6.ogg',
						'modularz_arkstation/modules/sounds-renewal/sound/ambience/radio/7.ogg',
						'modularz_arkstation/modules/sounds-renewal/sound/ambience/radio/8.ogg',
						'modularz_arkstation/modules/sounds-renewal/sound/ambience/radio/9.ogg')

/area/awaymission/beach
	forced_ambience = TRUE
	ambient_buzz = 'modularz_arkstation/modules/sounds-renewal/sound/ambience/beach.ogg'
	ambient_buzz_vol = 25

/area/centcom/syndicate_mothership
	ambient_buzz = 'modularz_arkstation/modules/sounds-renewal/sound/ambience/stadium.ogg'
	ambient_buzz_vol = 15
	min_ambience_cooldown = 15 SECONDS
	max_ambience_cooldown = 25 SECONDS
	ambientsounds = list('modular_nova/modules/encounters/sounds/alarm_radio.ogg',

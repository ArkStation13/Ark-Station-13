...
/obj/structure/window/reinforced/plasma/plastitanium
	...
	canSmoothWith = SMOOTH_GROUP_AIRLOCK + SMOOTH_GROUP_SYNDICATE_WALLS + SMOOTH_GROUP_SHUTTLE_PARTS + SMOOTH_GROUP_WINDOW_FULLTILE_PLASTITANIUM + SMOOTH_GROUP_PLASTITANIUM_WALLS

...
/atom/movable/distortion_effect
	...
	icon = 'modularz_arkstation/modules/supermatter_distortion/96x96.dmi'
	icon_state = "SM_base"
	pixel_x = -32
	pixel_y = -32
...
/obj/machinery/power/supermatter_crystal/proc/get_displacement_icon()
	switch(last_status)
		if(SUPERMATTER_INACTIVE)
			distort.icon = 'modularz_arkstation/modules/supermatter_distortion/96x96.dmi'
		...
		if(SUPERMATTER_DANGER)
			distort.icon = 'modularz_arkstation/modules/supermatter_distortion/160x160.dmi'
		...
		if(SUPERMATTER_EMERGENCY)
			distort.icon = 'modularz_arkstation/modules/supermatter_distortion/224x224.dmi'
		...
		if(SUPERMATTER_DELAMINATING)
			distort.icon = 'modularz_arkstation/modules/supermatter_distortion/288x288.dmi'

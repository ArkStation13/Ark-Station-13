...
/particles/dirt_kickup
	icon = 'modularz_arkstation/_master_files/icons/effects/96x157.dmi'
	icon_state = "smoke"
	width = 500
	height = 500
	count = 80
...
/particles/falling_debris
	icon = 'modularz_arkstation/_master_files/icons/effects/particles/generic.dmi'
	icon_state = "rock"
	width = 750
	height = 750
	count = 75
...
/particles/sparks_outwards
	icon = 'modularz_arkstation/_master_files/icons/effects/64x64.dmi'
	icon_state = "flare"
	width = 750
	height = 750
	count = 40
